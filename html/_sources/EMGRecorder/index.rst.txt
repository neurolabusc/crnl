...
-------------------------------------------
 ...
 - My  `ELEcro <http://www.mccauslandcenter.sc.edu/crnl/tools/elecro>`_  is a program that can filter and average data collected with EMG Recorder. It reads and writes BrainVision Analyzer (.VHDR), EDF (.EDF) and TMS32 (.S00) file formats.
 - My  `Biquad Filters <http://www.mccauslandcenter.sc.edu/crnl/tools/temporal>`_  web page is an interactive demonstration of the high pass, low pass and notch filters available in ELEcro and EMG Recorder.
